...
namespace Raytracer
{
    ...
    public readonly struct Material
    {
        ...
        public Vector3 TangentSpaceNormal(in Vector2 uv)
        {
            ...
            // B [0,1] -> Z [0,1]  (normal)
            var color = NormalMap.BilinearFilteredColor(uv);
        ...
        {
            var diffuseColor = (DiffuseMap != null) ? DiffuseMap.BilinearFilteredColor(uv) : DiffuseColor;
        ...
        public static readonly Material Checkerboard = new Material(new Color(0.005F, 0.005F, 0.005F), Color.White, Color.Black, 1.0F, 0.0F, 0.1F, 0.0F, 1.0F, Texture.Checkerboard(2, 2, 1000, Color.White, Color.Black), null);
    }
}
